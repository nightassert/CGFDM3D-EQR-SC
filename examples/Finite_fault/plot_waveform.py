...
for reciever_num in stations:

    # ! AWENO
    AWENO_receiver_v_x = np.loadtxt(
        "./data/SCFDM/Vx" + str(reciever_num) + ".txt")
    # print(AWENO_receiver_v_x.shape)
    AWENO_receiver_v_y = np.loadtxt(
        "./data/SCFDM/Vy" + str(reciever_num) + ".txt")
    AWENO_receiver_v_z = np.loadtxt(
        "./data/SCFDM/Vz" + str(reciever_num) + ".txt")
    
    AWENO_receiver_v_x = AWENO_receiver_v_x[:4200]
    AWENO_receiver_v_y = AWENO_receiver_v_y[:4200]
    AWENO_receiver_v_z = AWENO_receiver_v_z[:4200]
    ...
    CGFDM_receiver_v_x = np.loadtxt(
        "./data/CGFDM/Vx" + str(reciever_num) + ".txt")
    CGFDM_receiver_v_y = np.loadtxt(
        "./data/CGFDM/Vy" + str(reciever_num) + ".txt")
    CGFDM_receiver_v_z = np.loadtxt(
        "./data/CGFDM/Vz" + str(reciever_num) + ".txt")
    
    CGFDM_receiver_v_x = CGFDM_receiver_v_x[:4200]
    CGFDM_receiver_v_y = CGFDM_receiver_v_y[:4200]
    CGFDM_receiver_v_z = CGFDM_receiver_v_z[:4200]
    ...
    v_x_CGFDM = plt.plot(t, CGFDM_receiver_v_x /
                         CGFDM_max_value + reciever_num*disWid, "b-")
    v_x_AWENO = plt.plot(t, AWENO_receiver_v_x /
                         AWENO_max_value + reciever_num*disWid, "r--")
...
plt.savefig("./png/Compare3D.png", dpi=300)
